...
class UserLocationsControllerTest < ActionController::TestCase
  ...
  test "should create user_location" do
    assert_difference('UserLocation.count') do
      post :create, user_location: { lat: @user_location.lat, long: @user_location.long, timestamp: @user_location.timestamp, user_id: @user_location.user_id }
    end
  ...
  test "should update user_location" do
    put :update, id: @user_location, user_location: { lat: @user_location.lat, long: @user_location.long, timestamp: @user_location.timestamp, user_id: @user_location.user_id }
    assert_redirected_to user_location_path(assigns(:user_location))
  end
