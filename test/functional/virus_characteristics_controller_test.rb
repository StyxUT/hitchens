...
class VirusCharacteristicsControllerTest < ActionController::TestCase
  ...
  test "should create virus_characteristic" do
    assert_difference('VirusCharacteristic.count') do
      post :create, virus_characteristic: { characteristic_id: @virus_characteristic.characteristic_id, characteristic_level: @virus_characteristic.characteristic_level, virus_id: @virus_characteristic.virus_id }
    end
  ...
  test "should update virus_characteristic" do
    put :update, id: @virus_characteristic, virus_characteristic: { characteristic_id: @virus_characteristic.characteristic_id, characteristic_level: @virus_characteristic.characteristic_level, virus_id: @virus_characteristic.virus_id }
    assert_redirected_to virus_characteristic_path(assigns(:virus_characteristic))
  end
