...
class UserLocationsController < ApplicationController
  ...
  # POST /user_locations
  # POST /user_locations.json   curl -H "Content-Type:application/json" -H "Accept:application/json" -X POST -d '{"user_location":{"user_id":3,"long":103,"lat":103,"timestamp":"2012-06-06 11:55:00"}}' http://localhost:3000/user_locations
  def create
